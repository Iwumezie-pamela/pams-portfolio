      ...
      <div className='flex flex-col justify-center max-w-screen-lg mx-auto h-full w-full md:flex-row '>
        ...
        <div>
          <p className='max-w-md p-2 text-center md:text-left leading-7 pt-8 md:pt-0 md:max-w-[1042px] mx-auto lg:text-lg'>
            I am a Technically astute front-end developer with an experience in
            managing and configuring ReactJs. A proven track record of hands on
            experience in Html,Css and JavaScript in analysing,designing and
            implementing solutions to drive positive changes to optimize
            business processes. Seeking a challenging role where i can deploy my
            IT skill set to make transformative differences whilst nurturing a
            thriving developer career pathway
          </p>
          <a
            href='#projects'
