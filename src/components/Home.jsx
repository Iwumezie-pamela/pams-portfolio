    ...
    >
      {inView && (
        ...
        >
          ...
          <a
            href='#contacts'
            className='flex group w-fit  items-center rounded-md border-2 border-emerald-400 py-3 px-4  my-2 capitalize hover:bg-gray-100 text-lg hover:border-white transition-all ease-in-out duration-300  hover:text-[#000300] tracking-widest cursor-pointer'
          >
            Lets connect
